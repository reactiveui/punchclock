...
{
    /// <summary>The generic task completion source that provides the implementation.</summary>
    ...
    public TaskCompletionSource() => _inner = new(TaskCreationOptions.RunContinuationsAsynchronously);
    ...
    internal void SetCanceled() => _inner.SetCanceled();
