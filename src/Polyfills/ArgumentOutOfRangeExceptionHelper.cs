...
internal static class ArgumentOutOfRangeExceptionHelper
{
    ...
    /// <param name="paramName">The parameter name.</param>
    internal static void ThrowIfLessThan(int value, int other, [CallerArgumentExpression(nameof(value))] string? paramName = null)
    {
        if (value >= other)
        {
            return;
    ...
    /// <param name="other">The lower bound.</param>
    /// <param name="paramName">The parameter name.</param>
    internal static void ThrowIfLessThan(TimeSpan value, TimeSpan other, [CallerArgumentExpression(nameof(value))] string? paramName = null)
    {
    ...
    /// <param name="other">The lower bound.</param>
    /// <param name="paramName">The parameter name.</param>
    internal static void ThrowIfLessThanOrEqual(TimeSpan value, TimeSpan other, [CallerArgumentExpression(nameof(value))] string? paramName = null)
    {
        if (value > other)
        {
            return;
